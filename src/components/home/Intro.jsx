  ...
  return (
    <div ref={sectionRef} className="p-2 md:p-6 bg-[#070302] w-full">
      ...
      {scenes.map((scene, index) => (
        ...
        >
          <div className="h-full md:w-2/3 relative mt-9 rounded-2xl overflow-hidden">
            <img
              src={scene.src}
              alt={scene.title}
            ...
            <div className="absolute w-2/3 text-end md:text-start md:w-1/2 bottom-5 md:bottom-1/7 right-4 md:right-10 font-[ethnic] text-white">
